package com.jaehyeon.basic.material.selectioncomponents
...
import com.jaehyeon.basic.material.selectioncomponents.ui.theme.SelectionComponentsTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            SelectionComponentsTheme {
